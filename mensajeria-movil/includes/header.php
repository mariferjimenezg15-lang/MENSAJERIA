...
<title><?= isset($tituloPagina) ? htmlspecialchars($tituloPagina) . ' - ' : '' ?>Mensajería Móvil</title>
...
<nav class="navbar navbar-expand-lg navbar-dark app-navbar">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="dashboard.php">💬 Mensajería Móvil</a>
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        ...
        <li class="nav-item"><a class="nav-link" href="mis_telefonos.php">Mis Teléfonos</a></li>
        <li class="nav-item"><a class="nav-link" href="enviar_mensaje.php">Enviar Mensaje</a></li>
        <li class="nav-item"><a class="nav-link" href="historial.php">Historial</a></li>
        <li class="nav-item dropdown ms-lg-2">
          <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" role="button" data-bs-toggle="dropdown">
            <?= htmlspecialchars($u['nombre']) ?>
            <span class="badge bg-light text-dark rounded-pill">Cliente</span>
          </a>
